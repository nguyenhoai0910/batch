...
set _namefile=DC_sync_DR-file_store_services.bat
...
IF %_status%==true (
	pushd \\10.88.90.68\f$
	xcopy Website\FileStorageService_VAT\fs_service_release\storage\deposit_contract\%DATE:~10,4%\%DATE:~4,2%\%Yest% F:\Website\FileStorageService_VAT\fs_service_release\storage\deposit_contract\%DATE:~10,4%\%DATE:~4,2%\%Yest% /E /H /C /I /Y /F >> %_log%
	popd \\10.88.90.68\f$
)	
type %_log%
ECHO ====================================================================================
